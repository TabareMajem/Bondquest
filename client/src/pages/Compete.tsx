    ...
    >
      ...
      <div className="hidden lg:block mb-6">
        <p className="text-white mb-4">
          Challenge other couples, test your knowledge about each other, and earn rewards 
          through fun relationship competitions.
        </p>
      </div>
      ...
      {activeTab === "couple" && (
        <div className="lg:grid lg:grid-cols-2 lg:gap-6">
          <div className="lg:col-span-2 mb-6">
            <h2 className="text-xl text-white font-semibold mb-4 lg:text-center">Choose a Challenge</h2>
          </div>
          
          {/* Trivia Showdown Card */}
          <div 
            className="bg-gradient-to-br from-pink-500/90 to-purple-600/90 backdrop-blur-md rounded-2xl shadow-xl border border-pink-500/20 p-5 flex items-center cursor-pointer mb-5 lg:mb-0 transform transition-transform hover:scale-102 hover:shadow-2xl"
          ...
          <div 
            className="bg-gradient-to-br from-orange-400/90 to-pink-500/90 backdrop-blur-md rounded-2xl shadow-xl border border-orange-400/20 p-5 flex items-center cursor-pointer mb-5 lg:mb-0 transform transition-transform hover:scale-102 hover:shadow-2xl"
            onClick={() => navigate("/quizzes")}
          >
          ...
          <div 
            className="bg-gradient-to-br from-blue-500/90 to-indigo-600/90 backdrop-blur-md rounded-2xl shadow-xl border border-blue-500/20 p-5 flex items-center cursor-pointer mb-5 lg:mb-0 transform transition-transform hover:scale-102 hover:shadow-2xl"
            onClick={() => navigate("/quizzes")}
          >
            <div className="w-16 h-16 mr-4 flex items-center justify-center">
          ...
          <div 
            className="bg-gradient-to-br from-amber-400/90 to-orange-500/90 backdrop-blur-md rounded-2xl shadow-xl border border-amber-400/20 p-5 flex items-center cursor-pointer mb-5 lg:mb-0 transform transition-transform hover:scale-102 hover:shadow-2xl"
            onClick={() => navigate("/quizzes")}
          >
            <div className="w-16 h-16 mr-4 flex items-center justify-center">
              <div className="w-12 h-12 rounded-full bg-white/20 flex items-center justify-center">
      ...
      {activeTab === "partner" && (
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/10 flex flex-col items-center justify-center text-center lg:max-w-lg lg:mx-auto">
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl overflow-hidden shadow-xl border border-white/10">
          ...
          <div className="divide-y divide-white/10">
            <div className="p-4 flex items-center">
              ...
              <div className="flex-1">
                <span className="text-white font-medium">Mike & Sarah</span>
              </div>
              <div className="flex items-center">
                <span className="text-white">68 pts</span>
              </div>
            </div>
            ...
            <div className="p-4 flex items-center">
              ...
              <div className="flex-1">
                <span className="text-white font-medium">David & Jen</span>
              </div>
              <div className="flex items-center">
